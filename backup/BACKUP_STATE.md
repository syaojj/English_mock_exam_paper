...
- 백업본: `backup/mock-exam-extractor-v4.3-backup.html` (최신)
...
├── backup/
│   ├── mock-exam-extractor-v4.3-backup.html  ← v4.3 백업본 (최신)
│   ├── mock-exam-extractor-v4.2.1-backup.html
│   ├── mock-exam-extractor-v4.2-backup.html
│   ├── mock-exam-extractor-v3.5-backup.html  ← v3.5 백업본
...
## 복원 방법
1. `backup/mock-exam-extractor-v4.3-backup.html` 복사
2. 프로젝트 루트의 `mock-exam-extractor.html`을 덮어쓰기

PowerShell 예시:
```powershell
Copy-Item "backup\mock-exam-extractor-v4.3-backup.html" -Destination "mock-exam-extractor.html" -Force
```
